...
FUNCTION(CHECK_CUDA_ARCH ARCH VERSION)
IF(KOKKOS_ARCH_${ARCH})
  SET(FLAG "sm_${VERSION}")
  ...
  ELSE()
    ...
    ENDIF()
  ENDIF()
SET(KOKKOS_CUDA_ARCH_NUMBER ${VERSION} PARENT_SCOPE)
ENDIF()
ENDFUNCTION()


CHECK_CUDA_ARCH(KEPLER30  30)
CHECK_CUDA_ARCH(KEPLER32  32)
CHECK_CUDA_ARCH(KEPLER35  35)
CHECK_CUDA_ARCH(KEPLER37  37)
CHECK_CUDA_ARCH(MAXWELL50 50)
CHECK_CUDA_ARCH(MAXWELL52 52)
CHECK_CUDA_ARCH(MAXWELL53 53)
CHECK_CUDA_ARCH(PASCAL60  60)
CHECK_CUDA_ARCH(PASCAL61  61)
CHECK_CUDA_ARCH(VOLTA70   70)
CHECK_CUDA_ARCH(VOLTA72   72)
CHECK_CUDA_ARCH(TURING75  75)

INCLUDE(${KOKKOS_SRC_PATH}/cmake/kokkos_suggest_cuda_arch.cmake)
...
IF (KOKKOS_ENABLE_CUDA)
  FIND_PACKAGE(CUDA)
  IF (CUDA_FOUND)
    ADD_EXECUTABLE(kokkos_cuda_version ${CMAKE_CURRENT_LIST_DIR}/compile_tests/cuda_test.cc)
    TARGET_LINK_LIBRARIES(kokkos_cuda_version ${CUDA_LIBRARIES})
    TARGET_INCLUDE_DIRECTORIES(kokkos_cuda_version PRIVATE ${KOKKOS_TOP_BUILD_DIR} ${KOKKOS_SOURCE_DIR}/core/src)
  ELSE()
    MESSAGE(SEND_ERROR "No CUDA is found. Validation cannot be performed")
  ENDIF()
  ADD_CUSTOM_TARGET(cuda_version COMMAND kokkos_cuda_version)
ENDIF()
